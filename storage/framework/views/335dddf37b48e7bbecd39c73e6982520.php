...
<body>
    ...
    <div class="overflow-container">
        ...
        <div class="number-row">
            <?php $__currentLoopData = $movies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $moviespart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="number-cell">
                    <span><?php echo e($moviespart->rank); ?></span>
                    <div class="empty-cell" style="position:relative;">
                        
                        <a  onclick="redirectTo('<?php echo e(route('movies.redirect', $moviespart->id)); ?>')">
                            <img src="<?php echo e($moviespart->rank_link); ?>" alt="" style="height:205px">
                        </a>
                    </div>
                </div>
    ...
    <div class="row">
        ...
        <div class="row-posters" id="rowpost1">
            <?php $__currentLoopData = $data->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <section class="d-flex">
                    <div class="card">
                        <img src="<?php echo e($item->poster_link); ?>" class="row-poster"
                            onclick="redirectTo('<?php echo e(route('movies.redirect', $item->id)); ?>')">
                        <div class="card-body">
    ...
    <div class="row">
        ...
        <div class="row-posters" id="rowpost2">
            <?php $__currentLoopData = $data->skip(10)->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <section class="d-flex">
                    <div class="card">
                        <img src="<?php echo e($item->poster_link); ?>" class="row-poster"
                            onclick="redirectTo('<?php echo e(route('movies.redirect', $item->id)); ?>')">
    ...
    <div class="row">
        ...
        <div class="row-posters" id="rowpost3">
            <?php $__currentLoopData = $data->skip(20)->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <section class="d-flex">
                    <div class="card">
                        <img src="<?php echo e($item->poster_link); ?>" class="row-poster"
                            onclick="redirectTo('<?php echo e(route('movies.redirect', $item->id)); ?>')">
    ...
    <div class="row">
        ...
        <div class="row-posters" id="rowpost4">
            <?php $__currentLoopData = $data->skip(30)->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <section class="d-flex">
                    <div class="card">
                        <img src="<?php echo e($item->poster_link); ?>" class="row-poster"
                            onclick="redirectTo('<?php echo e(route('movies.redirect', $item->id)); ?>')">
    ...
    <div class="row">
        ...
        <div class="row-posters" id="rowpost5">
            <?php $__currentLoopData = $data->skip(40)->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <section class="d-flex">
                    <div class="card">
                        <img src="<?php echo e($item->poster_link); ?>" class="row-poster"
                            onclick="redirectTo('<?php echo e(route('movies.redirect', $item->id)); ?>')">
    ...
    <div class="row">
        ...
        <div class="row-posters" id="rowpost6">
            <?php $__currentLoopData = $data->skip(50)->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <section class="d-flex">
                    <div class="card">
                        <img src="<?php echo e($item->poster_link); ?>" class="row-poster"
                            onclick="redirectTo('<?php echo e(route('movies.redirect', $item->id)); ?>')">
...
<?php /**PATH /application/resources/views/index.blade.php ENDPATH**/ ?>