    ...
    <div class="navbar-container">
        ...
        <div class="nav-item dropdown no-arrow">
            ...
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                ?>
                <img class="img-profile rounded-circle" src="../<?php echo e(Auth::user()->avartar); ?>">
    ...
    <div class="chat-bot">
        <div class="logo-chat" onclick="openChatBot(this)">
            ...
            <div class="logo-message">
                ...
                <img src="<?php echo e(asset('../datasources/img/logoai.png')); ?>" style="height: 40px; weight:40px;" alt="Chat Logo"
                    class="chat-logo">
            </div>
        </div>
        ...
        <div class="chat-content" id="cha">
            <i class="logochat">
                <img class="logochatimg" src="<?php echo e(asset('../datasources/img/netflop_chatboxlogo.png')); ?>" alt="netflix-font"
                    border="0">
            </i>
            <div class="close-chat" onclick="closeChatBot(this)">
                <i class='bx bx-x'></i>
            </div>
            <div class="content-text" user="../<?php echo e(AUTH::user()->avartar); ?>">
...
<?php /**PATH /application/resources/views/layout/user_navbar.blade.php ENDPATH**/ ?>