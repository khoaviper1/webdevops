        ...
        <div class="container-profile">
            ...
            <form action="/update-profile" method="POST" enctype="multipart/form-data">
              ...
              <div class="profile-pic">
                  <img src="<?php echo e(Auth::user()->avartar); ?>" alt="Avatar" class="avatar" id="avatar" onclick="UserImage(this)" onload="window.URL.revokeObjectURL(this.src)">
              ...
              <div class="profile-info">
                  ...
                  <input type="email" id="email" name="email" value="<?php echo e(Auth::user()->email); ?>" readonly>
          
                  <label for="phone">Phone</label>
                  <input type="text" id="phone" name="phone" value="<?php echo e(Auth::user()->phoneNumber); ?>" required>
          
                  <label for="address">Address</label>
                  <input type="text" id="address" name="address" value="<?php echo e(Auth::user()->address); ?>" required>
...
<?php /**PATH /application/resources/views/profile.blade.php ENDPATH**/ ?>